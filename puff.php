...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Puff | Móveis Doraly</title>
			...
			<div id="page">
				...
				<div id="thumbs" class="navigation"><!-- Start thumbs-->
					<ul class="thumbs noscript" style="text-align: center;">
						<li>
							<a class="thumb" name="puff-feijão" href="img/puff/puff-feijao.png" title="Puff Feijão">
								<img src="img/puff/puff-feijao_s.png" alt="Puff Feijão" />
								<span class="titulo-img-esquerdo">Puff Feijão</span>
							</a>
							<div class="caption">
								<div class="image-title">Puff Feijão</div>
								<div class="image-desc"></div>
							</div>
						</li>
						<li>
							<a class="thumb" name="puff-feijão2" href="img/puff/puff-feijao2.png" title="Puff Feijão">
								<img src="img/puff/puff-feijao2_s.png" alt="Puff Feijão" />
								<span class="titulo-img-esquerdo">Puff Feijão</span>
							</a>
							<div class="caption">
								<div class="image-title">Puff Feijão</div>
